# defmodule ClecodesEx.Database do
#   use GenServer
#   require Logger
...
#     Logger.warn "ClecodesEx.Repo has crashed: #{inspect reason}"
...
#   defp try_start() do
#     case ClecodesEx.Repo.start_link([]) do
#       {:ok, pid} ->
#         pid
#       {:error, {:already_started, _pid}} ->
#         raise "Wasn't expecting ClecodesEx.Repo to be started but it was!"
#       {:error, reason} ->
#         Logger.warn "Unable to start ClecodesEx.Repo: #{inspect reason}"
#         nil
#     end
#   end
# end
